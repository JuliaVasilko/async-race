...
export class CarSvgComponent extends Component {
  svgIcon: SVGElement | null = null;

  constructor(color: string, size: number = 24) {
    super({ className: 'car-icon' });
